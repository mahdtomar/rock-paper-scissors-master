...
const loadingDiv = div.cloneNode();
const loadingText = document.createTextNode(`the results is`);
...
choices.addEventListener("click", (e) => {
  ...
  if (e.target.className !== "choices") {
    ...
    function pcChoice(rand) {
      rand =  generateRandom()
      if (rand > 0 && rand < 4) {
        choices.innerHTML += `<div class="scissors choice">
        ...
        choices.innerHTML += `<div class="rock choice">
        ...
        choices.innerHTML += `<div class="paper choice">
